...
# ################################################################################################
# std config
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 129379246ns
# 1 cached loop
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 130695214ns
# 2 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 129379246ns
# 3 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 128615086ns
# 4 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 128028430ns
# 5 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 127869838ns
# 6 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 127705086ns
# 7 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 127609470ns
# 8 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 127513994ns
# 9 cached loops
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 127485466ns
# 10 cached loops
read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 127466898ns
# -start 0us -end 300us
