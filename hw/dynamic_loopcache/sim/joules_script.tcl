...
# ################################################################################################
# std config
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 131624450ns
# w = 1
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 133952182ns
# w = 2
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 133944030ns
# w = 3
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 133918458ns
# w = 4
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 131631250ns
# w = 5
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 131624450ns
# w = 6
# read_stimulus -file ../waves.shm -dut_instance /:/neorv32_top_inst -frame_count 1000 -start 1015194ns -end 131624450ns
...
# write_power_profile -format shm -levels 10 -rtl_type hier -out power
